...
var ColorPicker_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => '.flex-row[data-v-06bdfe81]{display:flex;flex-direction:row;align-items:center}.flex-column[data-v-06bdfe81]{display:flex;flex-direction:column;align-items:center}.cbtn[data-v-06bdfe81]{border:1px solid #dcdfe6;background:#ffffff;border-radius:4px;width:40px;height:40px;padding:6px}.cbtn-inner[data-v-06bdfe81]{background:#dcdfe6;width:100%;height:100%}.panel[data-v-06bdfe81]{position:absolute;background:#fff;top:45px;left:0;width:240px;border:1px solid #dcdfe6;border-radius:6px;z-index:1000}.panel[data-v-06bdfe81]:before{content:"";display:block;position:absolute;top:-6px;left:10px;border-left:6px solid transparent;border-right:6px solid transparent;border-bottom:6px solid #dcdfe6}.panel[data-v-06bdfe81]:after{content:"";display:block;position:absolute;top:-5px;left:10px;border-left:6px solid transparent;border-right:6px solid transparent;border-bottom:6px solid #ffffff}.activeMode-wrapper[data-v-06bdfe81]{border-bottom:1px solid #dcdfe6;height:40px;display:flex;flex-direction:row;align-items:center;padding-left:12px}.btn-activeMode[data-v-06bdfe81]{border:1px solid #ff7d3a;margin-right:12px;border-radius:50%;width:14px;height:14px;cursor:pointer}.btn-activeMode.solid[data-v-06bdfe81]{background:#ffc9b6}.btn-activeMode.solid.gray[data-v-06bdfe81]{border:1px solid #7d7d7d;background:#e2e2e2}.btn-activeMode.linear[data-v-06bdfe81]{background:linear-gradient(180deg,#ffc9b6,#ff5011)}.btn-activeMode.linear.gray[data-v-06bdfe81]{border:1px solid #7d7d7d;background:linear-gradient(180deg,#ffffff,#999999)}.btn-activeMode.radial[data-v-06bdfe81]{background-image:radial-gradient(circle,#ffc9b6,#ff5011)}.btn-activeMode.radial.gray[data-v-06bdfe81]{border:1px solid #7d7d7d;background:radial-gradient(circle,#ffffff,#999999)}.palette-wrapper[data-v-06bdfe81]{margin:10px;height:140px;position:relative;border:1px solid #dcdfe6;border-radius:4px}.palette[data-v-06bdfe81]{position:absolute;overflow:hidden;inset:0px;border-radius:4px;background:rgb(255,0,0)}.palette .white[data-v-06bdfe81]{position:absolute;inset:0px;background:linear-gradient(to right,#fff,rgba(255,255,255,0))}.palette .black[data-v-06bdfe81]{position:absolute;inset:0px;background:linear-gradient(to top,#000,rgba(0,0,0,0))}.picker[data-v-06bdfe81]{position:absolute;width:14px;height:14px;top:-4px;left:-4px}.picker[data-v-06bdfe81]:before{content:"";top:3px;left:3px;position:absolute;width:6px;height:6px;display:block;background:rgba(255,255,255,0);box-shadow:0 0 0 1px #979797,0 0 0 3px #fff,0 0 0 4px #979797;border-radius:50%;cursor:default}.picker.on[data-v-06bdfe81]:before{box-shadow:0 0 0 1px #979797,0 0 0 3px #f50,0 0 0 4px #979797}.dropper[data-v-06bdfe81]{width:25px;height:30px;background:url(data:image/png;base64,) center center no-repeat;background-size:25px}.grad-wrapper[data-v-06bdfe81]{display:flex;flex-direction:row;justify-content:space-between;align-items:center;margin:10px 10px 0}.grad-wrapper .grad-bar[data-v-06bdfe81]{border:1px solid #aaaaaa;border-radius:8px;height:12px;width:150px;background-image:url(data:image/png;base64,);background-size:auto 100%;display:absolute}.grad-wrapper .grad-bar.full-width[data-v-06bdfe81]{width:100%}.degree[data-v-06bdfe81]{border:1px solid #aaaaaa;border-radius:50%;width:20px;height:20px}.picker-deg[data-v-06bdfe81]{border:1px solid #aaaaaa;border-radius:5px;width:8px;height:8px;background:#cccccc}.huebar-wrapper[data-v-06bdfe81]{margin:10px;display:flex;flex-direction:row;justify-content:space-between;align-items:center}.huebar-wrapper .bar-wrapper[data-v-06bdfe81]{display:flex;flex-direction:column;justify-content:space-between;gap:5px}.huebar-wrapper .hue-bar[data-v-06bdfe81],.huebar-wrapper .opacity-bar[data-v-06bdfe81]{border:1px solid #aaaaaa;border-radius:8px;width:150px;height:12px}.huebar-wrapper .hue-bar[data-v-06bdfe81]{background:linear-gradient(to right,#f00 0%,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,#f00 100%)}.huebar-wrapper .opacity-bar[data-v-06bdfe81]{background-image:linear-gradient(to right,rgba(255,255,255,0) 0%,rgb(255,255,255) 100%),url(data:image/png;base64,);background-size:auto 100%}.preview-wrapper[data-v-06bdfe81]{width:30px;height:30px;border-radius:50%;border:1px solid #aaaaaa;background-image:url(data:image/png;base64,);background-size:50% 50%}.preview-color[data-v-06bdfe81]{width:28px;height:28px;border-radius:50%}\n')();
...
const _withScopeId = (n) => (pushScopeId("data-v-06bdfe81"), n = n(), popScopeId(), n);
...
var ColorPicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-06bdfe81"]]);
